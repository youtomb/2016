...
class Kids {
    ...
    async getInfo(video_id) {
        ...
        if (__classPrivateFieldGet(this, _Kids_session, "f").po_token) {
            extra_payload.serviceIntegrityDimensions = {
                poToken: __classPrivateFieldGet(this, _Kids_session, "f").po_token
            };
        }
        const watch_response = watch_endpoint.call(__classPrivateFieldGet(this, _Kids_session, "f").actions, extra_payload);
